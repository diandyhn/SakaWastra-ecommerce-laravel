<section class="py-8 antialiased dark:bg-gray-900 md:py-12">
    <div class="mx-auto max-w-screen-xl px-4 2xl:px-0">
      <div class="mb-4 items-end justify-center space-y-4 sm:flex sm:space-y-0 md:mb-8">
        <div>
          <h2 class="mt-3 text-xl font-semibold text-roseOfSharon-500 dark:text-white sm:text-6xl sm:font-extrabold">OUR PRODUCTS</h2>
        </div>
      </div>
        ...
        @foreach($products as $product)
            ...
            <div class="rounded-lg border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-700 dark:bg-gray-800">
                <div class="h-56 w-full">
                  <a href="#">
                    <img class="mx-auto h-full dark:hidden" src="/images/{{ $product->imageUrl }}" alt="{{ $product->name }}" />
                ...
                <div class="pt-6">
                  ...
                  <div class="mt-4 flex flex-wrap items-center justify-between gap-4">
                    <p class="text-2xl font-extrabold leading-tight text-roseOfSharon-950 dark:text-white">$ {{ number_format($product->price, 2) }}</p>
