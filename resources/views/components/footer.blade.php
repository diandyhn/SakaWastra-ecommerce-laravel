<footer class="mt-auto w-full py-10 px-4 sm:px-6 lg:px-8 mx-auto bg-roseOfSharon-200">
    <div class="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-6 mb-10">
      <div class="col-span-full hidden lg:col-span-1 lg:block">
        <a href="#" class="flex items-center">
            <img src="{{ asset('build/images/logo.png') }}" class="mr-3 h-8" alt="{{ config('app.name') }}" />
            <span class="self-center text-2xl font-semibold whitespace-nowrap text-roseOfSharon-950">
                Amaraprana </span>
        </a>
        <p class="mt-3 text-xs sm:text-sm text-roseOfSharon-600 dark:text-roseOfSharon-400">© 2024 Amaraprana.</p>
      </div>
      ...
      <div class="sm:flex sm:justify-between sm:items-center">
        ...
        <div class="flex flex-wrap justify-between items-center gap-3">
          <div class="mt-3 sm:hidden">
            ...
            <p class="mt-1 text-xs sm:text-sm text-roseOfSharon-600 dark:text-roseOfSharon-400">© 2024 Amaraprana.</p>
          </div>
